    ...
    <ScreenLayout eyebrow="Start a Story" title="Choose Story Mode" description="Guided mode keeps the existing AI film flow. AI Story Studio lets you write scenes, dialogues, voices, music, and preview as a custom workflow.">
      <div className="grid gap-6 sm:grid-cols-2">
        <div className="glass-panel rounded-[1.5rem] p-6">
          ...
          <p className="mt-3 text-sm text-white/90">Let the engine offer scenarios, choices and a structured setup for a smoother experience.</p>
          <div className="mt-6">
        ...
        <div className="glass-panel rounded-[1.5rem] p-6">
          ...
          <p className="mt-3 text-sm text-white/90">Write your own story scene by scene, generate AI-assisted dialogue, add voices/music, and preview the final video.</p>
          <div className="mt-6">
